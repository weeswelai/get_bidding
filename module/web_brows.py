...
class ListWebBrows:
            ...
            if settings:
                ...
                for key, value in settings["headers"].items():
                    if key == "User-Agent" and value:
                        ...
                        self.cookie = cookie_str_to_dict(value)
    ...
    @classmethod
    def init(cls, settings, class_name: str) -> Html:
        ...
        """
        if class_name in settings:
            settings = settings[class_name]
...
if __name__ == "__main__":
    ...
    # url = ""
    task = "zgzf"
    zgzf = ListWebBrows.init(json_settings, task)
